...
Finally, do consider configuring https://aws.amazon.com/blogs/security/how-to-receive-alerts-when-your-iam-configuration-changes/[alerts for changes to IAM configuration, window='_blank'] to detect any unplanned changes to IAM configuration.
