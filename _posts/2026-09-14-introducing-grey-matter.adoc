...
I built (and yes, heavily vibe-coded) https://github.com/naikoob/grey-matter[*Grey Matter*] to fix this friction. It is an open-source, reproducible second-brain framework designed specifically for humans and AI agents thinking together. 
